$PBExportHeader$nvo_pdftrailer.sru
forward
global type nvo_pdftrailer from dotnetobject
end type
end forward

global type nvo_pdftrailer from dotnetobject
end type
global nvo_pdftrailer nvo_pdftrailer

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.PdfWriter+PdfTrailer"
...
on nvo_pdftrailer.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdftrailer.destroy
