$PBExportHeader$nvo_pdfpheadercell.sru
forward
global type nvo_pdfpheadercell from dotnetobject
end type
end forward

global type nvo_pdfpheadercell from dotnetobject
end type
global nvo_pdfpheadercell nvo_pdfpheadercell

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.PdfPHeaderCell"
...
public function long get_scope()
public subroutine  set_scope(long al_value)
...
on nvo_pdfpheadercell.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdfpheadercell.destroy
