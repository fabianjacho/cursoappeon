$PBExportHeader$nvo_pdfgstate.sru
forward
global type nvo_pdfgstate from dotnetobject
end type
end forward

global type nvo_pdfgstate from dotnetobject
end type
global nvo_pdfgstate nvo_pdfgstate

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.PdfGState"
...
public subroutine  set_overprintstroking(boolean abln_value)
public subroutine  set_overprintnonstroking(boolean abln_value)
public subroutine  set_overprintmode(long al_value)
public subroutine  set_strokeopacity(real ar_value)
public subroutine  set_fillopacity(real ar_value)
public subroutine  set_alphaisshape(boolean abln_value)
public subroutine  set_textknockout(boolean abln_value)
public subroutine  set_blendmode(dotnetobject anv_value)
public subroutine  set_renderingintent(dotnetobject anv_value)
...
public subroutine  set_overprintstroking(boolean abln_value);
//*-----------------------------------------------------------------*/
//*  .NET property : OverPrintStroking
//*   Argument:
//*              Boolean abln_value
//*   Return : (None)
//*-----------------------------------------------------------------*/
...
This.overprintstroking = abln_value
end subroutine

public subroutine  set_overprintnonstroking(boolean abln_value);
//*-----------------------------------------------------------------*/
//*  .NET property : OverPrintNonStroking
//*   Argument:
//*              Boolean abln_value
//*   Return : (None)
//*-----------------------------------------------------------------*/
...
/* Trigger the dotnet property */
This.overprintnonstroking = abln_value
end subroutine

public subroutine  set_overprintmode(long al_value);
//*-----------------------------------------------------------------*/
//*  .NET property : OverPrintMode
//*   Argument:
//*              Long al_value
//*   Return : (None)
//*-----------------------------------------------------------------*/
...
/* Trigger the dotnet property */
This.overprintmode = al_value
end subroutine

public subroutine  set_strokeopacity(real ar_value);
//*-----------------------------------------------------------------*/
//*  .NET property : StrokeOpacity
//*   Argument:
//*              Real ar_value
//*   Return : (None)
//*-----------------------------------------------------------------*/
...
/* Trigger the dotnet property */
This.strokeopacity = ar_value
end subroutine

public subroutine  set_fillopacity(real ar_value);
//*-----------------------------------------------------------------*/
//*  .NET property : FillOpacity
//*   Argument:
//*              Real ar_value
//*   Return : (None)
//*-----------------------------------------------------------------*/
...
/* Trigger the dotnet property */
This.fillopacity = ar_value
end subroutine

public subroutine  set_alphaisshape(boolean abln_value);
//*-----------------------------------------------------------------*/
//*  .NET property : AlphaIsShape
//*   Argument:
//*              Boolean abln_value
//*   Return : (None)
//*-----------------------------------------------------------------*/
...
/* Trigger the dotnet property */
This.alphaisshape = abln_value
end subroutine

public subroutine  set_textknockout(boolean abln_value);
//*-----------------------------------------------------------------*/
//*  .NET property : TextKnockout
//*   Argument:
//*              Boolean abln_value
//*   Return : (None)
//*-----------------------------------------------------------------*/
...
/* Trigger the dotnet property */
This.textknockout = abln_value
end subroutine

public subroutine  set_blendmode(dotnetobject anv_value);
//*-----------------------------------------------------------------*/
//*  .NET property : BlendMode
//*   Argument:
//*              Dotnetobject anv_value
//*   Return : (None)
//*-----------------------------------------------------------------*/
...
/* Trigger the dotnet property */
This.blendmode = anv_value
end subroutine

public subroutine  set_renderingintent(dotnetobject anv_value);
//*-----------------------------------------------------------------*/
//*  .NET property : RenderingIntent
//*   Argument:
//*              Dotnetobject anv_value
//*   Return : (None)
//*-----------------------------------------------------------------*/
...
/* Trigger the dotnet property */
This.renderingintent = anv_value
end subroutine
...
on nvo_pdfgstate.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdfgstate.destroy
