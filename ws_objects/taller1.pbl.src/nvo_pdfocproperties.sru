$PBExportHeader$nvo_pdfocproperties.sru
forward
global type nvo_pdfocproperties from dotnetobject
end type
end forward

global type nvo_pdfocproperties from dotnetobject
end type
global nvo_pdfocproperties nvo_pdfocproperties

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.PdfOCProperties"
...
on nvo_pdfocproperties.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdfocproperties.destroy
