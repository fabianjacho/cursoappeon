$PBExportHeader$nvo_iteratoroptions.sru
forward
global type nvo_iteratoroptions from dotnetobject
end type
end forward

global type nvo_iteratoroptions from dotnetobject
end type
global nvo_iteratoroptions nvo_iteratoroptions

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.xmp.options.IteratorOptions"
...
public function boolean get_justchildren()
public subroutine  set_justchildren(boolean abln_value)
public function boolean get_justleafname()
public subroutine  set_justleafname(boolean abln_value)
public function boolean get_justleafnodes()
public subroutine  set_justleafnodes(boolean abln_value)
public function boolean get_omitqualifiers()
public subroutine  set_omitqualifiers(boolean abln_value)
...
/* Trigger the dotnet property */
This.justchildren = abln_value
end subroutine

public function boolean get_justleafname();
//*-----------------------------------------------------------------*/
//*  .NET property : JustLeafname
//*   Return : Boolean
//*-----------------------------------------------------------------*/
/* Store the Return value from dotnet property */
Boolean lbln_result
...
/* Trigger the dotnet property */
This.justleafname = abln_value
end subroutine

public function boolean get_justleafnodes();
//*-----------------------------------------------------------------*/
//*  .NET property : JustLeafnodes
//*   Return : Boolean
//*-----------------------------------------------------------------*/
/* Store the Return value from dotnet property */
Boolean lbln_result
...
/* Trigger the dotnet property */
lbln_result = This.justleafnodes
Return lbln_result
end function
...
/* Trigger the dotnet property */
This.justleafnodes = abln_value
end subroutine

public function boolean get_omitqualifiers();
//*-----------------------------------------------------------------*/
//*  .NET property : OmitQualifiers
//*   Return : Boolean
//*-----------------------------------------------------------------*/
/* Store the Return value from dotnet property */
Boolean lbln_result
...
/* Trigger the dotnet property */
lbln_result = This.omitqualifiers
Return lbln_result
end function
...
/* Trigger the dotnet property */
This.omitqualifiers = abln_value
end subroutine
...
on nvo_iteratoroptions.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_iteratoroptions.destroy
