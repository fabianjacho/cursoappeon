$PBExportHeader$nvo_pdfefstream.sru
forward
global type nvo_pdfefstream from dotnetobject
end type
end forward

global type nvo_pdfefstream from dotnetobject
end type
global nvo_pdfefstream nvo_pdfefstream

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.PdfEFStream"
...
on nvo_pdfefstream.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdfefstream.destroy
