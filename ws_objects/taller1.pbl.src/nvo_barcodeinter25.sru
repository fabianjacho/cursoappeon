$PBExportHeader$nvo_barcodeinter25.sru
forward
global type nvo_barcodeinter25 from dotnetobject
end type
end forward

global type nvo_barcodeinter25 from dotnetobject
end type
global nvo_barcodeinter25 nvo_barcodeinter25

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.BarcodeInter25"
...
public function string of_keepnumbers(string as_text)
public function char of_getchecksum(string as_text)
public function blob of_getbarsinter25(string as_text)
...
ls_result = This.keepnumbers(as_text)
Return ls_result
end function

public function char of_getchecksum(string as_text);
//*-----------------------------------------------------------------*/
//*  .NET function : GetChecksum
//*   Argument:
//*              String as_text
//*   Return : Char
//*-----------------------------------------------------------------*/
...
/* Trigger the dotnet function */
lch_result = This.getchecksum(as_text)
Return lch_result
end function

public function blob of_getbarsinter25(string as_text);
//*-----------------------------------------------------------------*/
//*  .NET function : GetBarsInter25
//*   Argument:
//*              String as_text
//*   Return : Blob
//*-----------------------------------------------------------------*/
...
/* Trigger the dotnet function */
lbyt_result = This.getbarsinter25(as_text)
Return lbyt_result
end function
...
on nvo_barcodeinter25.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_barcodeinter25.destroy
