$PBExportHeader$nvo_nooplogger.sru
forward
global type nvo_nooplogger from dotnetobject
end type
end forward

global type nvo_nooplogger from dotnetobject
end type
global nvo_nooplogger nvo_nooplogger

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.log.NoOpLogger"
...
public function dotnetobject of_getlogger(dotnetobject anv_name)
...
lnv_result = This.getlogger(anv_name)
Return lnv_result
end function
...
on nvo_nooplogger.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_nooplogger.destroy
