$PBExportHeader$nvo_pdfcopyforms.sru
forward
global type nvo_pdfcopyforms from dotnetobject
end type
end forward

global type nvo_pdfcopyforms from dotnetobject
end type
global nvo_pdfcopyforms nvo_pdfcopyforms

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.PdfCopyForms"
...
on nvo_pdfcopyforms.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdfcopyforms.destroy
