$PBExportHeader$nvo_cmapciduni.sru
forward
global type nvo_cmapciduni from dotnetobject
end type
end forward

global type nvo_cmapciduni from dotnetobject
end type
global nvo_cmapciduni nvo_cmapciduni

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.fonts.cmaps.CMapCidUni"
...
on nvo_cmapciduni.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_cmapciduni.destroy
