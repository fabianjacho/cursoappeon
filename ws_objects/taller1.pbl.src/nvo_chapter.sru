$PBExportHeader$nvo_chapter.sru
forward
global type nvo_chapter from dotnetobject
end type
end forward

global type nvo_chapter from dotnetobject
end type
global nvo_chapter nvo_chapter

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.Chapter"
...
on nvo_chapter.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_chapter.destroy
