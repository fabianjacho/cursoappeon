$PBExportHeader$nvo_langalt.sru
forward
global type nvo_langalt from dotnetobject
end type
end forward

global type nvo_langalt from dotnetobject
end type
global nvo_langalt nvo_langalt

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.xml.xmp.LangAlt"
...
public subroutine  of_addlanguage(string as_language,string as_value)
...
This.addlanguage(as_language,as_value)
end subroutine
...
on nvo_langalt.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_langalt.destroy
