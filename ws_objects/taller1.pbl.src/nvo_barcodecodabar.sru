$PBExportHeader$nvo_barcodecodabar.sru
forward
global type nvo_barcodecodabar from dotnetobject
end type
end forward

global type nvo_barcodecodabar from dotnetobject
end type
global nvo_barcodecodabar nvo_barcodecodabar

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.BarcodeCodabar"
...
public function blob of_getbarscodabar(string as_text)
public function string of_calculatechecksum(string as_code)
...
lbyt_result = This.getbarscodabar(as_text)
Return lbyt_result
end function

public function string of_calculatechecksum(string as_code);
//*-----------------------------------------------------------------*/
//*  .NET function : CalculateChecksum
//*   Argument:
//*              String as_code
//*   Return : String
//*-----------------------------------------------------------------*/
...
/* Trigger the dotnet function */
ls_result = This.calculatechecksum(as_code)
Return ls_result
end function
...
on nvo_barcodecodabar.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_barcodecodabar.destroy
