$PBExportHeader$nvo_pdfcollectionschema.sru
forward
global type nvo_pdfcollectionschema from dotnetobject
end type
end forward

global type nvo_pdfcollectionschema from dotnetobject
end type
global nvo_pdfcollectionschema nvo_pdfcollectionschema

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.collection.PdfCollectionSchema"
...
public subroutine  of_addfield(string as_name,dotnetobject anv_field)
...
This.addfield(as_name,anv_field)
end subroutine
...
on nvo_pdfcollectionschema.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdfcollectionschema.destroy
