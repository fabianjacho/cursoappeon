$PBExportHeader$nvo_xmpbasicschema.sru
forward
global type nvo_xmpbasicschema from dotnetobject
end type
end forward

global type nvo_xmpbasicschema from dotnetobject
end type
global nvo_xmpbasicschema nvo_xmpbasicschema

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.xml.xmp.XmpBasicSchema"
...
public subroutine  of_addcreatortool(string as_creator)
public subroutine  of_addcreatedate(string as_date)
public subroutine  of_addmoddate(string as_date)
public subroutine  of_addmetadatadate(string as_date)
public subroutine  of_addidentifiers(string as_id[])
public subroutine  of_addnickname(string as_name)
...
This.addcreatortool(as_creator)
end subroutine

public subroutine  of_addcreatedate(string as_date);
//*-----------------------------------------------------------------*/
//*  .NET function : AddCreateDate
//*   Argument:
//*              String as_date
//*   Return : (None)
//*-----------------------------------------------------------------*/
...
/* Trigger the dotnet function */
This.addcreatedate(as_date)
end subroutine

public subroutine  of_addmoddate(string as_date);
//*-----------------------------------------------------------------*/
//*  .NET function : AddModDate
//*   Argument:
//*              String as_date
//*   Return : (None)
//*-----------------------------------------------------------------*/
...
/* Trigger the dotnet function */
This.addmoddate(as_date)
end subroutine

public subroutine  of_addmetadatadate(string as_date);
//*-----------------------------------------------------------------*/
//*  .NET function : AddMetaDataDate
//*   Argument:
//*              String as_date
//*   Return : (None)
//*-----------------------------------------------------------------*/
...
/* Trigger the dotnet function */
This.addmetadatadate(as_date)
end subroutine

public subroutine  of_addidentifiers(string as_id[]);
//*-----------------------------------------------------------------*/
//*  .NET function : AddIdentifiers
//*   Argument:
//*              String as_id[]
//*   Return : (None)
//*-----------------------------------------------------------------*/
...
/* Trigger the dotnet function */
This.addidentifiers(as_id)
end subroutine

public subroutine  of_addnickname(string as_name);
//*-----------------------------------------------------------------*/
//*  .NET function : AddNickname
//*   Argument:
//*              String as_name
//*   Return : (None)
//*-----------------------------------------------------------------*/
...
on nvo_xmpbasicschema.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_xmpbasicschema.destroy
