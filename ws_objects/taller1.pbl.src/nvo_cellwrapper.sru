$PBExportHeader$nvo_cellwrapper.sru
forward
global type nvo_cellwrapper from dotnetobject
end type
end forward

global type nvo_cellwrapper from dotnetobject
end type
global nvo_cellwrapper nvo_cellwrapper

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.html.simpleparser.CellWrapper"
...
public function dotnetobject of_createpdfpcell(string as_tag,dotnetobject anv_chain)
...
public function dotnetobject get_cell()
public function real get_width()
public function boolean get_ispercentage()
end prototypes
...
lnv_result = This.createpdfpcell(as_tag,anv_chain)
Return lnv_result
end function
...
/* Trigger the dotnet property */
lbln_result = This.ispercentage
Return lbln_result
end function

on nvo_cellwrapper.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_cellwrapper.destroy
