$PBExportHeader$nvo_aliasoptions.sru
forward
global type nvo_aliasoptions from dotnetobject
end type
end forward

global type nvo_aliasoptions from dotnetobject
end type
global nvo_aliasoptions nvo_aliasoptions

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.xmp.options.AliasOptions"
...
public function dotnetobject of_topropertyoptions()
...
public function dotnetobject of_topropertyoptions();
//*-----------------------------------------------------------------*/
//*  .NET function : ToPropertyOptions
//*   Return : Dotnetobject
//*-----------------------------------------------------------------*/
...
lnv_result = This.topropertyoptions()
Return lnv_result
end function
...
on nvo_aliasoptions.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_aliasoptions.destroy
