$PBExportHeader$nvo_jpeg2000.sru
forward
global type nvo_jpeg2000 from dotnetobject
end type
end forward

global type nvo_jpeg2000 from dotnetobject
end type
global nvo_jpeg2000 nvo_jpeg2000

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.Jpeg2000"
...
public subroutine  of_jp2_read_boxhdr()
public function long of_getnumofcomps()
public function blob of_getbpcboxdata()
public function dotnetobject of_getcolorspecboxes()
public function boolean of_isjp2()
...
/* Trigger the dotnet function */
ll_result = This.getnumofcomps()
Return ll_result
end function

public function blob of_getbpcboxdata();
//*-----------------------------------------------------------------*/
//*  .NET function : GetBpcBoxData
//*   Return : Blob
//*-----------------------------------------------------------------*/
/* Store the Return value from dotnet function */
Blob lbyt_result
...
/* Trigger the dotnet function */
lbyt_result = This.getbpcboxdata()
Return lbyt_result
end function

public function dotnetobject of_getcolorspecboxes();
//*-----------------------------------------------------------------*/
//*  .NET function : GetColorSpecBoxes
//*   Return : Dotnetobject
//*-----------------------------------------------------------------*/
/* Store the Return value from dotnet function */
...
/* Trigger the dotnet function */
lnv_result = This.getcolorspecboxes()
Return lnv_result
end function
...
on nvo_jpeg2000.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_jpeg2000.destroy
