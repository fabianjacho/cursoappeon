$PBExportHeader$nvo_pdficcbased.sru
forward
global type nvo_pdficcbased from dotnetobject
end type
end forward

global type nvo_pdficcbased from dotnetobject
end type
global nvo_pdficcbased nvo_pdficcbased

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.PdfICCBased"
...
on nvo_pdficcbased.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdficcbased.destroy
