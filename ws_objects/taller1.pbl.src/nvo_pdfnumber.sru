$PBExportHeader$nvo_pdfnumber.sru
forward
global type nvo_pdfnumber from dotnetobject
end type
end forward

global type nvo_pdfnumber from dotnetobject
end type
global nvo_pdfnumber nvo_pdfnumber

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.PdfNumber"
...
public subroutine  of_increment()
...
public function double get_doublevalue()
public function real get_floatvalue()
...
/* Trigger the dotnet property */
ldb_result = This.doublevalue
Return ldb_result
end function

public function real get_floatvalue();
//*-----------------------------------------------------------------*/
//*  .NET property : FloatValue
//*   Return : Real
//*-----------------------------------------------------------------*/
/* Store the Return value from dotnet property */
Real lr_result
...
on nvo_pdfnumber.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdfnumber.destroy
