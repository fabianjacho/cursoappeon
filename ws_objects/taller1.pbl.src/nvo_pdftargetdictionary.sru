$PBExportHeader$nvo_pdftargetdictionary.sru
forward
global type nvo_pdftargetdictionary from dotnetobject
end type
end forward

global type nvo_pdftargetdictionary from dotnetobject
end type
global nvo_pdftargetdictionary nvo_pdftargetdictionary

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.collection.PdfTargetDictionary"
...
public subroutine  set_embeddedfilename(string as_value)
public subroutine  set_fileattachmentpagename(string as_value)
public subroutine  set_fileattachmentpage(long al_value)
public subroutine  set_fileattachmentname(string as_value)
public subroutine  set_fileattachmentindex(long al_value)
public subroutine  set_additionalpath(dotnetobject anv_value)
...
This.embeddedfilename = as_value
end subroutine

public subroutine  set_fileattachmentpagename(string as_value);
//*-----------------------------------------------------------------*/
//*  .NET property : FileAttachmentPagename
//*   Argument:
//*              String as_value
//*   Return : (None)
//*-----------------------------------------------------------------*/
...
/* Trigger the dotnet property */
This.fileattachmentpagename = as_value
end subroutine

public subroutine  set_fileattachmentpage(long al_value);
//*-----------------------------------------------------------------*/
//*  .NET property : FileAttachmentPage
//*   Argument:
//*              Long al_value
//*   Return : (None)
//*-----------------------------------------------------------------*/
...
/* Trigger the dotnet property */
This.fileattachmentpage = al_value
end subroutine

public subroutine  set_fileattachmentname(string as_value);
//*-----------------------------------------------------------------*/
//*  .NET property : FileAttachmentName
//*   Argument:
//*              String as_value
//*   Return : (None)
//*-----------------------------------------------------------------*/
...
/* Trigger the dotnet property */
This.fileattachmentname = as_value
end subroutine

public subroutine  set_fileattachmentindex(long al_value);
//*-----------------------------------------------------------------*/
//*  .NET property : FileAttachmentIndex
//*   Argument:
//*              Long al_value
//*   Return : (None)
//*-----------------------------------------------------------------*/
...
/* Trigger the dotnet property */
This.fileattachmentindex = al_value
end subroutine

public subroutine  set_additionalpath(dotnetobject anv_value);
//*-----------------------------------------------------------------*/
//*  .NET property : AdditionalPath
//*   Argument:
//*              Dotnetobject anv_value
//*   Return : (None)
//*-----------------------------------------------------------------*/
...
on nvo_pdftargetdictionary.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdftargetdictionary.destroy
