$PBExportHeader$nvo_pdfpsxobject.sru
forward
global type nvo_pdfpsxobject from dotnetobject
end type
end forward

global type nvo_pdfpsxobject from dotnetobject
end type
global nvo_pdfpsxobject nvo_pdfpsxobject

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.PdfPSXObject"
...
public function dotnetobject of_getformxobject(long al_compressionlevel)
public function boolean of_istagged()
public subroutine  of_setmatrix(real ar_a,real ar_b,real ar_c,real ar_d,real ar_e,real ar_f)
public subroutine  of_beginvariabletext()
public subroutine  of_endvariabletext()
...
public function dotnetobject get_boundingbox()
public subroutine  set_boundingbox(dotnetobject anv_value)
...
public function dotnetobject get_pagereference()
public subroutine  set_pagereference(dotnetobject anv_value)
public function boolean get_contenttagged()
public subroutine  set_contenttagged(boolean abln_value)
...
lnv_result = This.getformxobject(al_compressionlevel)
Return lnv_result
end function
...
/* Trigger the dotnet function */
This.setmatrix(ar_a,ar_b,ar_c,ar_d,ar_e,ar_f)
end subroutine

public subroutine  of_beginvariabletext();
//*-----------------------------------------------------------------*/
//*  .NET function : BeginVariableText
//*   Return : (None)
//*-----------------------------------------------------------------*/
/* Create .NET object */
If Not This.of_createOnDemand( ) Then
...
/* Trigger the dotnet function */
This.beginvariabletext()
end subroutine

public subroutine  of_endvariabletext();
//*-----------------------------------------------------------------*/
//*  .NET function : EndVariableText
//*   Return : (None)
//*-----------------------------------------------------------------*/
/* Create .NET object */
If Not This.of_createOnDemand( ) Then
...
/* Trigger the dotnet property */
This.pagereference = anv_value
end subroutine

public function boolean get_contenttagged();
//*-----------------------------------------------------------------*/
//*  .NET property : ContentTagged
//*   Return : Boolean
//*-----------------------------------------------------------------*/
/* Store the Return value from dotnet property */
Boolean lbln_result
...
/* Trigger the dotnet property */
lbln_result = This.contenttagged
Return lbln_result
end function
...
on nvo_pdfpsxobject.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdfpsxobject.destroy
