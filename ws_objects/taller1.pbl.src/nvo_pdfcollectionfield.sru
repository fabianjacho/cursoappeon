$PBExportHeader$nvo_pdfcollectionfield.sru
forward
global type nvo_pdfcollectionfield from dotnetobject
end type
end forward

global type nvo_pdfcollectionfield from dotnetobject
end type
global nvo_pdfcollectionfield nvo_pdfcollectionfield

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.collection.PdfCollectionField"
...
public function boolean of_iscollectionitem()
public function dotnetobject of_getvalue(string as_v)
...
public subroutine  set_order(long al_value)
public subroutine  set_visible(boolean abln_value)
public subroutine  set_editable(boolean abln_value)
...
lbln_result = This.iscollectionitem()
Return lbln_result
end function
...
/* Trigger the dotnet property */
This.visible = abln_value
end subroutine

public subroutine  set_editable(boolean abln_value);
//*-----------------------------------------------------------------*/
//*  .NET property : Editable
//*   Argument:
//*              Boolean abln_value
//*   Return : (None)
//*-----------------------------------------------------------------*/
...
on nvo_pdfcollectionfield.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdfcollectionfield.destroy
