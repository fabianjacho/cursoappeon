$PBExportHeader$nvo_pdfstructureelement.sru
forward
global type nvo_pdfstructureelement from dotnetobject
end type
end forward

global type nvo_pdfstructureelement from dotnetobject
end type
global nvo_pdfstructureelement nvo_pdfstructureelement

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.PdfStructureElement"
...
public function dotnetobject of_getparent(boolean abln_includestructtreeroot)
public function dotnetobject of_getattribute(dotnetobject anv_name)
public subroutine  of_setattribute(dotnetobject anv_name,dotnetobject anv_obj)
public subroutine  of_writeattributes(dotnetobject anv_element)
...
public function dotnetobject get_structuretype()
...
public function dotnetobject of_getparent(boolean abln_includestructtreeroot);
//*-----------------------------------------------------------------*/
//*  .NET function : GetParent
//*   Argument:
//*              Boolean abln_includestructtreeroot
//*   Return : Dotnetobject
//*-----------------------------------------------------------------*/
...
lnv_result = This.getparent(abln_includestructtreeroot)
Return lnv_result
end function

public function dotnetobject of_getattribute(dotnetobject anv_name);
//*-----------------------------------------------------------------*/
//*  .NET function : GetAttribute
//*   Argument:
...
/* Trigger the dotnet function */
lnv_result = This.getattribute(anv_name)
Return lnv_result
end function

public subroutine  of_setattribute(dotnetobject anv_name,dotnetobject anv_obj);
//*-----------------------------------------------------------------*/
//*  .NET function : SetAttribute
//*   Argument:
//*              Dotnetobject anv_name
...
/* Trigger the dotnet function */
This.setattribute(anv_name,anv_obj)
end subroutine

public subroutine  of_writeattributes(dotnetobject anv_element);
//*-----------------------------------------------------------------*/
//*  .NET function : WriteAttributes
//*   Argument:
...
/* Trigger the dotnet function */
This.writeattributes(anv_element)
end subroutine
...
on nvo_pdfstructureelement.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdfstructureelement.destroy
