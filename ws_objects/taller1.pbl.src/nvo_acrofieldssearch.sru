$PBExportHeader$nvo_acrofieldssearch.sru
forward
global type nvo_acrofieldssearch from dotnetobject
end type
end forward

global type nvo_acrofieldssearch from dotnetobject
end type
global nvo_acrofieldssearch nvo_acrofieldssearch

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.XfaForm+AcroFieldsSearch"
...
public function dotnetobject get_acroshort2longname()
public subroutine  set_acroshort2longname(dotnetobject anv_value)
...
public function dotnetobject get_acroshort2longname();
//*-----------------------------------------------------------------*/
//*  .NET property : AcroShort2LongName
//*   Return : Dotnetobject
//*-----------------------------------------------------------------*/
...
lnv_result = This.acroshort2longname
Return lnv_result
end function
...
/* Trigger the dotnet property */
This.acroshort2longname = anv_value
end subroutine
...
on nvo_acrofieldssearch.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_acrofieldssearch.destroy
