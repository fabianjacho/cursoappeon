$PBExportHeader$nvo_imagestore.sru
forward
global type nvo_imagestore from dotnetobject
end type
end forward

global type nvo_imagestore from dotnetobject
end type
global nvo_imagestore nvo_imagestore

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.html.simpleparser.ImageStore"
...
on nvo_imagestore.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_imagestore.destroy
