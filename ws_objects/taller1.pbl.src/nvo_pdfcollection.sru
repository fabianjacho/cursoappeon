$PBExportHeader$nvo_pdfcollection.sru
forward
global type nvo_pdfcollection from dotnetobject
end type
end forward

global type nvo_pdfcollection from dotnetobject
end type
global nvo_pdfcollection nvo_pdfcollection

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.collection.PdfCollection"
...
public subroutine  set_initialdocument(string as_value)
public function dotnetobject get_schema()
public subroutine  set_schema(dotnetobject anv_value)
public subroutine  set_sort(dotnetobject anv_value)
...
on nvo_pdfcollection.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdfcollection.destroy
