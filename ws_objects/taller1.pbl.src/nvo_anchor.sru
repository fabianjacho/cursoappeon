$PBExportHeader$nvo_anchor.sru
forward
global type nvo_anchor from dotnetobject
end type
end forward

global type nvo_anchor from dotnetobject
end type
global nvo_anchor nvo_anchor

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.Anchor"
...
public function string get_reference()
public subroutine  set_reference(string as_value)
...
on nvo_anchor.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_anchor.destroy
