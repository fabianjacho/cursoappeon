$PBExportHeader$nvo_barcode39.sru
forward
global type nvo_barcode39 from dotnetobject
end type
end forward

global type nvo_barcode39 from dotnetobject
end type
global nvo_barcode39 nvo_barcode39

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.Barcode39"
...
public function blob of_getbarscode39(string as_text)
public function string of_getcode39ex(string as_text)
...
lbyt_result = This.getbarscode39(as_text)
Return lbyt_result
end function

public function string of_getcode39ex(string as_text);
//*-----------------------------------------------------------------*/
//*  .NET function : GetCode39Ex
//*   Argument:
//*              String as_text
//*   Return : String
//*-----------------------------------------------------------------*/
...
/* Trigger the dotnet function */
ls_result = This.getcode39ex(as_text)
Return ls_result
end function
...
on nvo_barcode39.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_barcode39.destroy
