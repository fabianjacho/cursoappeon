$PBExportHeader$nvo_pdfdashpattern.sru
forward
global type nvo_pdfdashpattern from dotnetobject
end type
end forward

global type nvo_pdfdashpattern from dotnetobject
end type
global nvo_pdfdashpattern nvo_pdfdashpattern

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.PdfDashPattern"
...
public subroutine  of_add(real ar_n)
...
on nvo_pdfdashpattern.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdfdashpattern.destroy
