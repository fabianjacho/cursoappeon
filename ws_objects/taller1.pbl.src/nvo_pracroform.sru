$PBExportHeader$nvo_pracroform.sru
forward
global type nvo_pracroform from dotnetobject
end type
end forward

global type nvo_pracroform from dotnetobject
end type
global nvo_pracroform nvo_pracroform

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.PRAcroForm"
...
public function dotnetobject of_getrefbyname(string as_name)
public subroutine  of_readacroform(dotnetobject anv_root)
...
/* Trigger the dotnet function */
lnv_result = This.getrefbyname(as_name)
Return lnv_result
end function

public subroutine  of_readacroform(dotnetobject anv_root);
//*-----------------------------------------------------------------*/
//*  .NET function : ReadAcroForm
//*   Argument:
//*              Dotnetobject anv_root
//*   Return : (None)
//*-----------------------------------------------------------------*/
/* Create .NET object */
If Not This.of_createOnDemand( ) Then
...
on nvo_pracroform.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pracroform.destroy
