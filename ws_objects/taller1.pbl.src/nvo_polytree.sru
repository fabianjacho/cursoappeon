$PBExportHeader$nvo_polytree.sru
forward
global type nvo_polytree from dotnetobject
end type
end forward

global type nvo_polytree from dotnetobject
end type
global nvo_polytree nvo_polytree

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.parser.clipper.PolyTree"
...
public function dotnetobject of_getfirst()
public function dotnetobject of_getnext()
public function long get_total()
...
on nvo_polytree.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_polytree.destroy
