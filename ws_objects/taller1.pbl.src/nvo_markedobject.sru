$PBExportHeader$nvo_markedobject.sru
forward
global type nvo_markedobject from dotnetobject
end type
end forward

global type nvo_markedobject from dotnetobject
end type
global nvo_markedobject nvo_markedobject

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.MarkedObject"
...
on nvo_markedobject.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_markedobject.destroy
