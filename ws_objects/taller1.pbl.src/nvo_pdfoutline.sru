$PBExportHeader$nvo_pdfoutline.sru
forward
global type nvo_pdfoutline from dotnetobject
end type
end forward

global type nvo_pdfoutline from dotnetobject
end type
global nvo_pdfoutline nvo_pdfoutline

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.PdfOutline"
...
public function boolean of_setdestinationpage(dotnetobject anv_pagereference)
public subroutine  of_topdf(dotnetobject anv_writer,dotnetobject anv_os)
public subroutine  of_addkid(dotnetobject anv_outline)
...
public subroutine  set_indirectreference(dotnetobject anv_value)
public function dotnetobject get_parent()
public function dotnetobject get_pdfdestination()
public function long get_level()
public function dotnetobject get_kids()
public subroutine  set_kids(dotnetobject anv_value)
public function string get_tag()
public subroutine  set_tag(string as_value)
public function string get_title()
public subroutine  set_title(string as_value)
public function boolean get_open()
public subroutine  set_open(boolean abln_value)
public function dotnetobject get_color()
public subroutine  set_color(dotnetobject anv_value)
public function long get_style()
public subroutine  set_style(long al_value)
...
public function boolean of_setdestinationpage(dotnetobject anv_pagereference);
//*-----------------------------------------------------------------*/
//*  .NET function : SetDestinationPage
//*   Argument:
//*              Dotnetobject anv_pagereference
//*   Return : Boolean
//*-----------------------------------------------------------------*/
...
lbln_result = This.setdestinationpage(anv_pagereference)
Return lbln_result
end function
...
/* Trigger the dotnet property */
This.indirectreference = anv_value
end subroutine
...
/* Trigger the dotnet property */
lnv_result = This.pdfdestination
Return lnv_result
end function
...
on nvo_pdfoutline.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdfoutline.destroy
