$PBExportHeader$nvo_numberarray.sru
forward
global type nvo_numberarray from dotnetobject
end type
end forward

global type nvo_numberarray from dotnetobject
end type
global nvo_numberarray nvo_numberarray

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.NumberArray"
...
on nvo_numberarray.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_numberarray.destroy
