$PBExportHeader$nvo_imgjbig2.sru
forward
global type nvo_imgjbig2 from dotnetobject
end type
end forward

global type nvo_imgjbig2 from dotnetobject
end type
global nvo_imgjbig2 nvo_imgjbig2

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.ImgJBIG2"
...
public function blob get_globalbytes()
public function blob get_globalhash()
...
lbyt_result = This.globalbytes
Return lbyt_result
end function

public function blob get_globalhash();
//*-----------------------------------------------------------------*/
//*  .NET property : GlobalHash
//*   Return : Blob
//*-----------------------------------------------------------------*/
/* Store the Return value from dotnet property */
Blob lbyt_result
...
on nvo_imgjbig2.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_imgjbig2.destroy
