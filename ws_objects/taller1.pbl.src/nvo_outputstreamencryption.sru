$PBExportHeader$nvo_outputstreamencryption.sru
forward
global type nvo_outputstreamencryption from dotnetobject
end type
end forward

global type nvo_outputstreamencryption from dotnetobject
end type
global nvo_outputstreamencryption nvo_outputstreamencryption

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.OutputStreamEncryption"
...
on nvo_outputstreamencryption.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_outputstreamencryption.destroy
