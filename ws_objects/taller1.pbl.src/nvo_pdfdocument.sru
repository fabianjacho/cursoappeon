$PBExportHeader$nvo_pdfdocument.sru
forward
global type nvo_pdfdocument from dotnetobject
end type
end forward

global type nvo_pdfdocument from dotnetobject
end type
global nvo_pdfdocument nvo_pdfdocument

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.PdfDocument"
...
public function long of_getstructparentindex(dotnetobject anv_obj)
public function long of_getnextmarkpoint(dotnetobject anv_obj)
public function any of_getstructparentindexandnextmarkpoint(dotnetobject anv_obj)
public subroutine  of_addwriter(dotnetobject anv_writer)
...
public function dotnetobject of_endpage()
...
public function dotnetobject get_pagelabels()
...
public function long of_getstructparentindex(dotnetobject anv_obj);
//*-----------------------------------------------------------------*/
//*  .NET function : GetStructParentIndex
//*   Argument:
...
/* Trigger the dotnet function */
ll_result = This.getstructparentindex(anv_obj)
Return ll_result
end function

public function long of_getnextmarkpoint(dotnetobject anv_obj);
//*-----------------------------------------------------------------*/
//*  .NET function : GetNextMarkPoint
//*   Argument:
//*              Dotnetobject anv_obj
//*   Return : Long
//*-----------------------------------------------------------------*/
...
/* Trigger the dotnet function */
ll_result = This.getnextmarkpoint(anv_obj)
Return ll_result
end function

public function any of_getstructparentindexandnextmarkpoint(dotnetobject anv_obj);
//*-----------------------------------------------------------------*/
//*  .NET function : GetStructParentIndexAndNextMarkPoint
//*   Argument:
//*              Dotnetobject anv_obj
//*   Return : Long[]
//*-----------------------------------------------------------------*/
...
/* Trigger the dotnet function */
ll_result = This.getstructparentindexandnextmarkpoint(anv_obj)
Return ll_result
end function

public subroutine  of_addwriter(dotnetobject anv_writer);
//*-----------------------------------------------------------------*/
//*  .NET function : AddWriter
//*   Argument:
...
on nvo_pdfdocument.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdfdocument.destroy
