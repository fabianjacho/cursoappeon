$PBExportHeader$nvo_pdfboolean.sru
forward
global type nvo_pdfboolean from dotnetobject
end type
end forward

global type nvo_pdfboolean from dotnetobject
end type
global nvo_pdfboolean nvo_pdfboolean

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.PdfBoolean"
...
public function boolean get_booleanvalue()
...
on nvo_pdfboolean.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdfboolean.destroy
