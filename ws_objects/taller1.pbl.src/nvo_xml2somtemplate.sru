$PBExportHeader$nvo_xml2somtemplate.sru
forward
global type nvo_xml2somtemplate from dotnetobject
end type
end forward

global type nvo_xml2somtemplate from dotnetobject
end type
global nvo_xml2somtemplate nvo_xml2somtemplate

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.XfaForm+Xml2SomTemplate"
...
public function string of_getfieldtype(string as_s)
...
public function boolean get_dynamicform()
public subroutine  set_dynamicform(boolean abln_value)
...
ls_result = This.getfieldtype(as_s)
Return ls_result
end function
...
on nvo_xml2somtemplate.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_xml2somtemplate.destroy
