$PBExportHeader$nvo_pdfdictionary.sru
forward
global type nvo_pdfdictionary from dotnetobject
end type
end forward

global type nvo_pdfdictionary from dotnetobject
end type
global nvo_pdfdictionary nvo_pdfdictionary

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.PdfDictionary"
...
on nvo_pdfdictionary.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdfdictionary.destroy
