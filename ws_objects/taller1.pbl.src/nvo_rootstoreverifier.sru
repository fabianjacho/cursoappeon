$PBExportHeader$nvo_rootstoreverifier.sru
forward
global type nvo_rootstoreverifier from dotnetobject
end type
end forward

global type nvo_rootstoreverifier from dotnetobject
end type
global nvo_rootstoreverifier nvo_rootstoreverifier

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.security.RootStoreVerifier"
...
on nvo_rootstoreverifier.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_rootstoreverifier.destroy
