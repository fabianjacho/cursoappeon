$PBExportHeader$nvo_pdfxconformanceimp.sru
forward
global type nvo_pdfxconformanceimp from dotnetobject
end type
end forward

global type nvo_pdfxconformanceimp from dotnetobject
end type
global nvo_pdfxconformanceimp nvo_pdfxconformanceimp

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.intern.PdfXConformanceImp"
...
public function boolean of_ispdfx1a2001()
public function boolean of_ispdfx32002()
...
/* Trigger the dotnet function */
lbln_result = This.ispdfx1a2001()
Return lbln_result
end function

public function boolean of_ispdfx32002();
//*-----------------------------------------------------------------*/
//*  .NET function : IsPdfX32002
//*   Return : Boolean
//*-----------------------------------------------------------------*/
/* Store the Return value from dotnet function */
Boolean lbln_result
...
on nvo_pdfxconformanceimp.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdfxconformanceimp.destroy
