$PBExportHeader$nvo_type3font.sru
forward
global type nvo_type3font from dotnetobject
end type
end forward

global type nvo_type3font from dotnetobject
end type
global nvo_type3font nvo_type3font

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.Type3Font"
...
public function dotnetobject of_defineglyph(char ach_c,real ar_wx,real ar_llx,real ar_lly,real ar_urx,real ar_ury)
...
lnv_result = This.defineglyph(ref ach_c,ar_wx,ar_llx,ar_lly,ar_urx,ar_ury)
Return lnv_result
end function
...
on nvo_type3font.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_type3font.destroy
