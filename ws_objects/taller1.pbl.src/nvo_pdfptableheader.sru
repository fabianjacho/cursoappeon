$PBExportHeader$nvo_pdfptableheader.sru
forward
global type nvo_pdfptableheader from dotnetobject
end type
end forward

global type nvo_pdfptableheader from dotnetobject
end type
global nvo_pdfptableheader nvo_pdfptableheader

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.PdfPTableHeader"
...
on nvo_pdfptableheader.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdfptableheader.destroy
