$PBExportHeader$nvo_pdfimage.sru
forward
global type nvo_pdfimage from dotnetobject
end type
end forward

global type nvo_pdfimage from dotnetobject
end type
global nvo_pdfimage nvo_pdfimage

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.PdfImage"
...
public function dotnetobject get_name()
...
on nvo_pdfimage.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdfimage.destroy
