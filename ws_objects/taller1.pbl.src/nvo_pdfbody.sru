$PBExportHeader$nvo_pdfbody.sru
forward
global type nvo_pdfbody from dotnetobject
end type
end forward

global type nvo_pdfbody from dotnetobject
end type
global nvo_pdfbody nvo_pdfbody

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.PdfBody"
...
on nvo_pdfbody.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdfbody.destroy
