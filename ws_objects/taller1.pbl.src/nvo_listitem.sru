$PBExportHeader$nvo_listitem.sru
forward
global type nvo_listitem from dotnetobject
end type
end forward

global type nvo_listitem from dotnetobject
end type
global nvo_listitem nvo_listitem

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.ListItem"
...
public function dotnetobject of_cloneshallow(boolean abln_spacingbefore)
public subroutine  of_setindentationleft(real ar_indentation,boolean abln_autoindent)
public subroutine  of_adjustlistsymbolfont()
public function dotnetobject of_breakup()
...
public function dotnetobject get_listsymbol()
public subroutine  set_listsymbol(dotnetobject anv_value)
public function dotnetobject get_listbody()
public function dotnetobject get_listlabel()
...
public function real get_firstlineindent()
public subroutine  set_firstlineindent(real ar_value)
...
lnv_result = This.cloneshallow(abln_spacingbefore)
Return lnv_result
end function

public subroutine  of_setindentationleft(real ar_indentation,boolean abln_autoindent);
//*-----------------------------------------------------------------*/
//*  .NET function : SetIndentationLeft
//*   Argument:
//*              Real ar_indentation
//*              Boolean abln_autoindent
//*   Return : (None)
//*-----------------------------------------------------------------*/
/* Create .NET object */
If Not This.of_createOnDemand( ) Then
...
/* Trigger the dotnet function */
This.setindentationleft(ar_indentation,abln_autoindent)
end subroutine

public subroutine  of_adjustlistsymbolfont();
//*-----------------------------------------------------------------*/
//*  .NET function : AdjustListSymbolFont
//*   Return : (None)
//*-----------------------------------------------------------------*/
/* Create .NET object */
If Not This.of_createOnDemand( ) Then
...
/* Trigger the dotnet function */
This.adjustlistsymbolfont()
end subroutine

public function dotnetobject of_breakup();
//*-----------------------------------------------------------------*/
//*  .NET function : BreakUp
//*   Return : Dotnetobject
//*-----------------------------------------------------------------*/
/* Store the Return value from dotnet function */
Dotnetobject lnv_result
...
/* Trigger the dotnet property */
lnv_result = This.listbody
Return lnv_result
end function

public function dotnetobject get_listlabel();
//*-----------------------------------------------------------------*/
//*  .NET property : ListLabel
//*   Return : Dotnetobject
//*-----------------------------------------------------------------*/
/* Store the Return value from dotnet property */
Dotnetobject lnv_result
...
/* Trigger the dotnet property */
lr_result = This.firstlineindent
Return lr_result
end function
...
on nvo_listitem.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_listitem.destroy
