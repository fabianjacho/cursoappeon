$PBExportHeader$nvo_pdfname.sru
forward
global type nvo_pdfname from dotnetobject
end type
end forward

global type nvo_pdfname from dotnetobject
end type
global nvo_pdfname nvo_pdfname

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.PdfName"
...
public function long of_compareto(dotnetobject anv_name)
public function boolean of_equals(dotnetobject anv_obj)
public function long of_gethashcode()
public function blob of_encodename(string as_name)
public function string of_decodename(string as_name)
...
public function long of_compareto1(dotnetobject anv_obj)
...
ll_result = This.compareto(anv_name)
Return ll_result
end function
...
/* Trigger the dotnet function */
lbyt_result = This.encodename(as_name)
Return lbyt_result
end function

public function string of_decodename(string as_name);
//*-----------------------------------------------------------------*/
//*  .NET function : DecodeName
//*   Argument:
//*              String as_name
//*   Return : String
//*-----------------------------------------------------------------*/
...
/* Trigger the dotnet function */
ls_result = This.decodename(as_name)
Return ls_result
end function
...
on nvo_pdfname.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdfname.destroy
