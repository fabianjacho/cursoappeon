$PBExportHeader$nvo_pdfpageeventhelper.sru
forward
global type nvo_pdfpageeventhelper from dotnetobject
end type
end forward

global type nvo_pdfpageeventhelper from dotnetobject
end type
global nvo_pdfpageeventhelper nvo_pdfpageeventhelper

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.PdfPageEventHelper"
...
on nvo_pdfpageeventhelper.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdfpageeventhelper.destroy
