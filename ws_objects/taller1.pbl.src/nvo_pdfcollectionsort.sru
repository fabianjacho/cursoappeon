$PBExportHeader$nvo_pdfcollectionsort.sru
forward
global type nvo_pdfcollectionsort from dotnetobject
end type
end forward

global type nvo_pdfcollectionsort from dotnetobject
end type
global nvo_pdfcollectionsort nvo_pdfcollectionsort

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.collection.PdfCollectionSort"
...
public subroutine  of_setsortorder(boolean abln_ascending)
public subroutine  of_setsortorder(boolean abln_ascending[])
...
This.setsortorder(abln_ascending)
end subroutine
...
on nvo_pdfcollectionsort.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdfcollectionsort.destroy
