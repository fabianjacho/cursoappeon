$PBExportHeader$nvo_pdfsignature.sru
forward
global type nvo_pdfsignature from dotnetobject
end type
end forward

global type nvo_pdfsignature from dotnetobject
end type
global nvo_pdfsignature nvo_pdfsignature

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.PdfSignature"
...
public subroutine  set_byterange(long al_value[])
public subroutine  set_contents(blob ablo_value)
public subroutine  set_cert(blob ablo_value)
public subroutine  set_name(string as_value)
public subroutine  set_date(dotnetobject anv_value)
...
This.byterange = al_value
end subroutine

public subroutine  set_contents(blob ablo_value);
//*-----------------------------------------------------------------*/
//*  .NET property : Contents
//*   Argument:
//*              Blob ablo_value
//*   Return : (None)
//*-----------------------------------------------------------------*/
...
on nvo_pdfsignature.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdfsignature.destroy
