$PBExportHeader$nvo_xmpmmschema.sru
forward
global type nvo_xmpmmschema from dotnetobject
end type
end forward

global type nvo_xmpmmschema from dotnetobject
end type
global nvo_xmpmmschema nvo_xmpmmschema

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.xml.xmp.XmpMMSchema"
...
on nvo_xmpmmschema.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_xmpmmschema.destroy
