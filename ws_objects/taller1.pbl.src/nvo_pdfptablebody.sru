$PBExportHeader$nvo_pdfptablebody.sru
forward
global type nvo_pdfptablebody from dotnetobject
end type
end forward

global type nvo_pdfptablebody from dotnetobject
end type
global nvo_pdfptablebody nvo_pdfptablebody

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.PdfPTableBody"
...
on nvo_pdfptablebody.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdfptablebody.destroy
