$PBExportHeader$nvo_pdflayermembership.sru
forward
global type nvo_pdflayermembership from dotnetobject
end type
end forward

global type nvo_pdflayermembership from dotnetobject
end type
global nvo_pdflayermembership nvo_pdflayermembership

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.PdfLayerMembership"
...
public subroutine  of_addmember(dotnetobject anv_layer)
...
public function dotnetobject get_layers()
public subroutine  set_visibilitypolicy(dotnetobject anv_value)
public subroutine  set_visibilityexpression(dotnetobject anv_value)
...
/* Trigger the dotnet property */
lnv_result = This.layers
Return lnv_result
end function

public subroutine  set_visibilitypolicy(dotnetobject anv_value);
//*-----------------------------------------------------------------*/
//*  .NET property : VisibilityPolicy
//*   Argument:
//*              Dotnetobject anv_value
//*   Return : (None)
//*-----------------------------------------------------------------*/
...
/* Trigger the dotnet property */
This.visibilitypolicy = anv_value
end subroutine

public subroutine  set_visibilityexpression(dotnetobject anv_value);
//*-----------------------------------------------------------------*/
//*  .NET property : VisibilityExpression
//*   Argument:
//*              Dotnetobject anv_value
//*   Return : (None)
//*-----------------------------------------------------------------*/
...
/* Trigger the dotnet property */
This.visibilityexpression = anv_value
end subroutine
...
on nvo_pdflayermembership.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdflayermembership.destroy
