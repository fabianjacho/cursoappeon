$PBExportHeader$nvo_pdfstream.sru
forward
global type nvo_pdfstream from dotnetobject
end type
end forward

global type nvo_pdfstream from dotnetobject
end type
global nvo_pdfstream nvo_pdfstream

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.PdfStream"
...
on nvo_pdfstream.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdfstream.destroy
