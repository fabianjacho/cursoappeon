$PBExportHeader$nvo_cmapbytecid.sru
forward
global type nvo_cmapbytecid from dotnetobject
end type
end forward

global type nvo_cmapbytecid from dotnetobject
end type
global nvo_cmapbytecid nvo_cmapbytecid

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.fonts.cmaps.CMapByteCid"
...
public function long of_decodesingle(dotnetobject anv_seq)
public function string of_decodesequence(dotnetobject anv_seq)
...
public function long of_decodesingle(dotnetobject anv_seq);
//*-----------------------------------------------------------------*/
//*  .NET function : DecodeSingle
//*   Argument:
//*              Dotnetobject anv_seq
//*   Return : Long
//*-----------------------------------------------------------------*/
...
ll_result = This.decodesingle(anv_seq)
Return ll_result
end function

public function string of_decodesequence(dotnetobject anv_seq);
//*-----------------------------------------------------------------*/
//*  .NET function : DecodeSequence
//*   Argument:
//*              Dotnetobject anv_seq
//*   Return : String
//*-----------------------------------------------------------------*/
...
/* Trigger the dotnet function */
ls_result = This.decodesequence(anv_seq)
Return ls_result
end function
...
on nvo_cmapbytecid.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_cmapbytecid.destroy
