$PBExportHeader$nvo_xmparray.sru
forward
global type nvo_xmparray from dotnetobject
end type
end forward

global type nvo_xmparray from dotnetobject
end type
global nvo_xmparray nvo_xmparray

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.xml.xmp.XmpArray"
...
on nvo_xmparray.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_xmparray.destroy
