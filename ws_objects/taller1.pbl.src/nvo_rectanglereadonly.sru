$PBExportHeader$nvo_rectanglereadonly.sru
forward
global type nvo_rectanglereadonly from dotnetobject
end type
end forward

global type nvo_rectanglereadonly from dotnetobject
end type
global nvo_rectanglereadonly nvo_rectanglereadonly

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.RectangleReadOnly"
...
on nvo_rectanglereadonly.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_rectanglereadonly.destroy
