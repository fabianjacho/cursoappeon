$PBExportHeader$nvo_pdfstring.sru
forward
global type nvo_pdfstring from dotnetobject
end type
end forward

global type nvo_pdfstring from dotnetobject
end type
global nvo_pdfstring nvo_pdfstring

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.PdfString"
...
on nvo_pdfstring.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdfstring.destroy
