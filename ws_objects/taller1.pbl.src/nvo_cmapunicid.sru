$PBExportHeader$nvo_cmapunicid.sru
forward
global type nvo_cmapunicid from dotnetobject
end type
end forward

global type nvo_cmapunicid from dotnetobject
end type
global nvo_cmapunicid nvo_cmapunicid

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.fonts.cmaps.CMapUniCid"
...
public function long of_lookup(long al_character)
public function dotnetobject of_exporttounicode()
...
ll_result = This.lookup(al_character)
Return ll_result
end function

public function dotnetobject of_exporttounicode();
//*-----------------------------------------------------------------*/
//*  .NET function : ExportToUnicode
//*   Return : Dotnetobject
//*-----------------------------------------------------------------*/
/* Store the Return value from dotnet function */
...
/* Trigger the dotnet function */
lnv_result = This.exporttounicode()
Return lnv_result
end function
...
on nvo_cmapunicid.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_cmapunicid.destroy
