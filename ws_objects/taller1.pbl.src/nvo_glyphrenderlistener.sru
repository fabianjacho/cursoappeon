$PBExportHeader$nvo_glyphrenderlistener.sru
forward
global type nvo_glyphrenderlistener from dotnetobject
end type
end forward

global type nvo_glyphrenderlistener from dotnetobject
end type
global nvo_glyphrenderlistener nvo_glyphrenderlistener

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.parser.GlyphRenderListener"
...
on nvo_glyphrenderlistener.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_glyphrenderlistener.destroy
