$PBExportHeader$nvo_greeklist.sru
forward
global type nvo_greeklist from dotnetobject
end type
end forward

global type nvo_greeklist from dotnetobject
end type
global nvo_greeklist nvo_greeklist

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.GreekList"
...
on nvo_greeklist.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_greeklist.destroy
