$PBExportHeader$nvo_barcodeeansupp.sru
forward
global type nvo_barcodeeansupp from dotnetobject
end type
end forward

global type nvo_barcodeeansupp from dotnetobject
end type
global nvo_barcodeeansupp nvo_barcodeeansupp

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.BarcodeEANSUPP"
...
on nvo_barcodeeansupp.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_barcodeeansupp.destroy
