$PBExportHeader$nvo_pdfpageeventforwarder.sru
forward
global type nvo_pdfpageeventforwarder from dotnetobject
end type
end forward

global type nvo_pdfpageeventforwarder from dotnetobject
end type
global nvo_pdfpageeventforwarder nvo_pdfpageeventforwarder

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.events.PdfPageEventForwarder"
...
public subroutine  of_addpageevent(dotnetobject anv_eventa)
...
on nvo_pdfpageeventforwarder.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdfpageeventforwarder.destroy
