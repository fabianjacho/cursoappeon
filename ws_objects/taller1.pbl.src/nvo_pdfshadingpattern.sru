$PBExportHeader$nvo_pdfshadingpattern.sru
forward
global type nvo_pdfshadingpattern from dotnetobject
end type
end forward

global type nvo_pdfshadingpattern from dotnetobject
end type
global nvo_pdfshadingpattern nvo_pdfshadingpattern

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.PdfShadingPattern"
...
public subroutine  of_addtobody()
...
public function any get_matrix()
public subroutine  set_matrix(real ar_value[])
public function dotnetobject get_shading()
...
/* Trigger the dotnet property */
This.matrix = ar_value
end subroutine

public function dotnetobject get_shading();
//*-----------------------------------------------------------------*/
//*  .NET property : Shading
//*   Return : Dotnetobject
//*-----------------------------------------------------------------*/
/* Store the Return value from dotnet property */
Dotnetobject lnv_result
...
on nvo_pdfshadingpattern.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdfshadingpattern.destroy
