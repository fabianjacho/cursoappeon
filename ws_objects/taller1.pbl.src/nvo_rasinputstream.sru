$PBExportHeader$nvo_rasinputstream.sru
forward
global type nvo_rasinputstream from dotnetobject
end type
end forward

global type nvo_rasinputstream from dotnetobject
end type
global nvo_rasinputstream nvo_rasinputstream

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.io.RASInputStream"
...
public function long of_read(blob ablo_buffer,long al_offset,long al_len)
...
/* Trigger the dotnet function */
ll_result = This.read(ablo_buffer,al_offset,al_len)
Return ll_result
end function
...
on nvo_rasinputstream.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_rasinputstream.destroy
