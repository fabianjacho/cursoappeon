$PBExportHeader$nvo_pdfarray.sru
forward
global type nvo_pdfarray from dotnetobject
end type
end forward

global type nvo_pdfarray from dotnetobject
end type
global nvo_pdfarray nvo_pdfarray

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.PdfArray"
...
on nvo_pdfarray.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdfarray.destroy
