$PBExportHeader$nvo_barcodepostnet.sru
forward
global type nvo_barcodepostnet from dotnetobject
end type
end forward

global type nvo_barcodepostnet from dotnetobject
end type
global nvo_barcodepostnet nvo_barcodepostnet

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.BarcodePostnet"
...
public function blob of_getbarspostnet(string as_text)
...
lbyt_result = This.getbarspostnet(as_text)
Return lbyt_result
end function
...
on nvo_barcodepostnet.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_barcodepostnet.destroy
