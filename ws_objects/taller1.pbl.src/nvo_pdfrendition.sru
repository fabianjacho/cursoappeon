$PBExportHeader$nvo_pdfrendition.sru
forward
global type nvo_pdfrendition from dotnetobject
end type
end forward

global type nvo_pdfrendition from dotnetobject
end type
global nvo_pdfrendition nvo_pdfrendition

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.PdfRendition"
...
on nvo_pdfrendition.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdfrendition.destroy
