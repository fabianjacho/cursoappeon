$PBExportHeader$nvo_pdfborderarray.sru
forward
global type nvo_pdfborderarray from dotnetobject
end type
end forward

global type nvo_pdfborderarray from dotnetobject
end type
global nvo_pdfborderarray nvo_pdfborderarray

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.PdfBorderArray"
...
on nvo_pdfborderarray.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdfborderarray.destroy
