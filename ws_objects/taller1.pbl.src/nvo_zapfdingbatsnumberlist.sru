$PBExportHeader$nvo_zapfdingbatsnumberlist.sru
forward
global type nvo_zapfdingbatsnumberlist from dotnetobject
end type
end forward

global type nvo_zapfdingbatsnumberlist from dotnetobject
end type
global nvo_zapfdingbatsnumberlist nvo_zapfdingbatsnumberlist

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.ZapfDingbatsNumberList"
...
public function long get_numbertype()
public subroutine  set_numbertype(long al_value)
...
on nvo_zapfdingbatsnumberlist.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_zapfdingbatsnumberlist.destroy
