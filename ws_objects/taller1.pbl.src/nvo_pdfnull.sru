$PBExportHeader$nvo_pdfnull.sru
forward
global type nvo_pdfnull from dotnetobject
end type
end forward

global type nvo_pdfnull from dotnetobject
end type
global nvo_pdfnull nvo_pdfnull

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.PdfNull"
...
on nvo_pdfnull.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdfnull.destroy
