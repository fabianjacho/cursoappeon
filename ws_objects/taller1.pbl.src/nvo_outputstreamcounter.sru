$PBExportHeader$nvo_outputstreamcounter.sru
forward
global type nvo_outputstreamcounter from dotnetobject
end type
end forward

global type nvo_outputstreamcounter from dotnetobject
end type
global nvo_outputstreamcounter nvo_outputstreamcounter

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.OutputStreamCounter"
...
public subroutine  of_resetcounter()
...
public function longlong get_counter()
...
on nvo_outputstreamcounter.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_outputstreamcounter.destroy
