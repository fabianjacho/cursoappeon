$PBExportHeader$nvo_pdfliteral.sru
forward
global type nvo_pdfliteral from dotnetobject
end type
end forward

global type nvo_pdfliteral from dotnetobject
end type
global nvo_pdfliteral nvo_pdfliteral

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.PdfLiteral"
...
public function long get_poslength()
...
on nvo_pdfliteral.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdfliteral.destroy
