$PBExportHeader$nvo_pdftransparencygroup.sru
forward
global type nvo_pdftransparencygroup from dotnetobject
end type
end forward

global type nvo_pdftransparencygroup from dotnetobject
end type
global nvo_pdftransparencygroup nvo_pdftransparencygroup

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.PdfTransparencyGroup"
...
public subroutine  set_isolated(boolean abln_value)
public subroutine  set_knockout(boolean abln_value)
...
This.isolated = abln_value
end subroutine

public subroutine  set_knockout(boolean abln_value);
//*-----------------------------------------------------------------*/
//*  .NET property : Knockout
//*   Argument:
//*              Boolean abln_value
//*   Return : (None)
//*-----------------------------------------------------------------*/
...
on nvo_pdftransparencygroup.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdftransparencygroup.destroy
