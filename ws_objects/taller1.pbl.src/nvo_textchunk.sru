$PBExportHeader$nvo_textchunk.sru
forward
global type nvo_textchunk from dotnetobject
end type
end forward

global type nvo_textchunk from dotnetobject
end type
global nvo_textchunk nvo_textchunk

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.parser.LocationTextExtractionStrategy+TextChunk"
...
public function dotnetobject get_location()
end prototypes
...
/* Trigger the dotnet function */
lbln_result = This.sameline(anv_lastchunk)
Return lbln_result
end function
...
/* Trigger the dotnet property */
lnv_result = This.location
Return lnv_result
end function

on nvo_textchunk.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_textchunk.destroy
