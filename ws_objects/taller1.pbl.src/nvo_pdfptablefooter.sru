$PBExportHeader$nvo_pdfptablefooter.sru
forward
global type nvo_pdfptablefooter from dotnetobject
end type
end forward

global type nvo_pdfptablefooter from dotnetobject
end type
global nvo_pdfptablefooter nvo_pdfptablefooter

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.PdfPTableFooter"
...
on nvo_pdfptablefooter.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdfptablefooter.destroy
