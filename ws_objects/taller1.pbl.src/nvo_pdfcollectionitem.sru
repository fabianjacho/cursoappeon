$PBExportHeader$nvo_pdfcollectionitem.sru
forward
global type nvo_pdfcollectionitem from dotnetobject
end type
end forward

global type nvo_pdfcollectionitem from dotnetobject
end type
global nvo_pdfcollectionitem nvo_pdfcollectionitem

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.collection.PdfCollectionItem"
...
public subroutine  of_additem(string as_key,string as_value)
public subroutine  of_additem(string as_key,dotnetobject anv_value)
public subroutine  of_additem1(string as_key,dotnetobject anv_d)
public subroutine  of_additem2(string as_key,dotnetobject anv_n)
public subroutine  of_additem(string as_key,datetime adt_c)
public subroutine  of_additem(string as_key,long al_i)
public subroutine  of_additem(string as_key,real ar_f)
public subroutine  of_additem(string as_key,double adb_d)
public subroutine  of_setprefix(string as_key,string as_prefix)
...
/* Trigger the dotnet function */
This.additem(as_key,adb_d)
end subroutine

public subroutine  of_setprefix(string as_key,string as_prefix);
//*-----------------------------------------------------------------*/
//*  .NET function : SetPrefix
//*   Argument:
//*              String as_key
//*              String as_prefix
//*   Return : (None)
...
/* Trigger the dotnet function */
This.setprefix(as_key,as_prefix)
end subroutine
...
on nvo_pdfcollectionitem.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdfcollectionitem.destroy
