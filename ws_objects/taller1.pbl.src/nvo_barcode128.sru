$PBExportHeader$nvo_barcode128.sru
forward
global type nvo_barcode128 from dotnetobject
end type
end forward

global type nvo_barcode128 from dotnetobject
end type
global nvo_barcode128 nvo_barcode128

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.Barcode128"
...
public function char of_getstartsymbol(long al_codeset)
public function string of_removefnc1(string as_code)
public function string of_gethumanreadableuccean(string as_code)
public function string of_getrawtext(string as_text,boolean abln_ucc,long al_codeset)
public function string of_getrawtext(string as_text,boolean abln_ucc)
public function blob of_getbarscode128raw(string as_text)
...
public function long get_codeset()
public subroutine  set_codeset(long al_value)
...
lch_result = This.getstartsymbol(al_codeset)
Return lch_result
end function

public function string of_removefnc1(string as_code);
//*-----------------------------------------------------------------*/
//*  .NET function : RemoveFNC1
//*   Argument:
//*              String as_code
//*   Return : String
//*-----------------------------------------------------------------*/
...
/* Trigger the dotnet function */
ls_result = This.removefnc1(as_code)
Return ls_result
end function

public function string of_gethumanreadableuccean(string as_code);
//*-----------------------------------------------------------------*/
//*  .NET function : GetHumanReadableUCCEAN
//*   Argument:
//*              String as_code
//*   Return : String
//*-----------------------------------------------------------------*/
...
/* Trigger the dotnet function */
ls_result = This.gethumanreadableuccean(as_code)
Return ls_result
end function

public function string of_getrawtext(string as_text,boolean abln_ucc,long al_codeset);
//*-----------------------------------------------------------------*/
//*  .NET function : GetRawText
//*   Argument:
//*              String as_text
//*              Boolean abln_ucc
//*              Long al_codeset
...
/* Trigger the dotnet function */
ls_result = This.getrawtext(as_text,abln_ucc,al_codeset)
Return ls_result
end function
...
/* Trigger the dotnet function */
ls_result = This.getrawtext(as_text,abln_ucc)
Return ls_result
end function

public function blob of_getbarscode128raw(string as_text);
//*-----------------------------------------------------------------*/
//*  .NET function : GetBarsCode128Raw
//*   Argument:
//*              String as_text
//*   Return : Blob
//*-----------------------------------------------------------------*/
...
/* Trigger the dotnet function */
lbyt_result = This.getbarscode128raw(as_text)
Return lbyt_result
end function
...
on nvo_barcode128.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_barcode128.destroy
