$PBExportHeader$nvo_certificateverifier.sru
forward
global type nvo_certificateverifier from dotnetobject
end type
end forward

global type nvo_certificateverifier from dotnetobject
end type
global nvo_certificateverifier nvo_certificateverifier

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.security.CertificateVerifier"
...
on nvo_certificateverifier.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_certificateverifier.destroy
