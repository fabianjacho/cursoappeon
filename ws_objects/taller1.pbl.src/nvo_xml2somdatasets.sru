$PBExportHeader$nvo_xml2somdatasets.sru
forward
global type nvo_xml2somdatasets from dotnetobject
end type
end forward

global type nvo_xml2somdatasets from dotnetobject
end type
global nvo_xml2somdatasets nvo_xml2somdatasets

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.XfaForm+Xml2SomDatasets"
...
public function dotnetobject of_insertnode(dotnetobject anv_n,string as_shortname)
...
lnv_result = This.insertnode(anv_n,as_shortname)
Return lnv_result
end function
...
on nvo_xml2somdatasets.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_xml2somdatasets.destroy
