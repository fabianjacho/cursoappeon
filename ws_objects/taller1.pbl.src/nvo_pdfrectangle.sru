$PBExportHeader$nvo_pdfrectangle.sru
forward
global type nvo_pdfrectangle from dotnetobject
end type
end forward

global type nvo_pdfrectangle from dotnetobject
end type
global nvo_pdfrectangle nvo_pdfrectangle

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.PdfRectangle"
...
public function real of_getleft(long al_margin)
public function real of_getright(long al_margin)
public function real of_gettop(long al_margin)
public function real of_getbottom(long al_margin)
public function dotnetobject of_transform(dotnetobject anv_transform)
public function dotnetobject of_transform1(dotnetobject anv_transform)
...
public function dotnetobject get_rectangle()
...
public function dotnetobject get_rotate()
...
/* Trigger the dotnet function */
lr_result = This.getleft(al_margin)
Return lr_result
end function
...
/* Trigger the dotnet function */
lr_result = This.getright(al_margin)
Return lr_result
end function
...
/* Trigger the dotnet function */
lr_result = This.gettop(al_margin)
Return lr_result
end function
...
/* Trigger the dotnet function */
lr_result = This.getbottom(al_margin)
Return lr_result
end function
...
/* Trigger the dotnet function */
lnv_result = This.transform(anv_transform)
Return lnv_result
end function
...
on nvo_pdfrectangle.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdfrectangle.destroy
