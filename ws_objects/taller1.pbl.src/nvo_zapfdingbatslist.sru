$PBExportHeader$nvo_zapfdingbatslist.sru
forward
global type nvo_zapfdingbatslist from dotnetobject
end type
end forward

global type nvo_zapfdingbatslist from dotnetobject
end type
global nvo_zapfdingbatslist nvo_zapfdingbatslist

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.ZapfDingbatsList"
...
public subroutine  of_setdingbatcolor(dotnetobject anv_zapfdingbatcolor)
...
public function long get_charnumber()
public subroutine  set_charnumber(long al_value)
...
public subroutine  of_setdingbatcolor(dotnetobject anv_zapfdingbatcolor);
//*-----------------------------------------------------------------*/
//*  .NET function : setDingbatColor
//*   Argument:
//*              Dotnetobject anv_zapfdingbatcolor
//*   Return : (None)
//*-----------------------------------------------------------------*/
/* Create .NET object */
...
This.setdingbatcolor(anv_zapfdingbatcolor)
end subroutine
...
on nvo_zapfdingbatslist.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_zapfdingbatslist.destroy
