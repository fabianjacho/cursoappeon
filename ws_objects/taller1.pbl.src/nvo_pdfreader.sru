$PBExportHeader$nvo_pdfreader.sru
forward
global type nvo_pdfreader from dotnetobject
end type
end forward

global type nvo_pdfreader from dotnetobject
end type
global nvo_pdfreader nvo_pdfreader

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.PdfReader"
...
public function blob of_flatedecode(blob ablo_inp,boolean abln_strict)
public function blob of_asciihexdecode(blob ablo_inp)
public function blob of_ascii85decode(blob ablo_inp)
public function blob of_lzwdecode(blob ablo_inp)
...
public function blob of_getpagecontent(dotnetobject anv_page)
...
public function blob of_decodebytes(blob ablo_b,dotnetobject anv_streamdictionary)
public function blob of_decodebytes(blob ablo_b,dotnetobject anv_streamdictionary,dotnetobject anv_filterhandlers)
public function blob of_getstreambytes(dotnetobject anv_stream,dotnetobject anv_file)
public function blob of_getstreambytes(dotnetobject anv_stream)
public function blob of_getstreambytesraw(dotnetobject anv_stream,dotnetobject anv_file)
public function blob of_getstreambytesraw(dotnetobject anv_stream)
...
public function dotnetobject of_getnormalizedrectangle(dotnetobject anv_box)
public function boolean of_istagged()
public function dotnetobject of_getpdfobjectrelease(dotnetobject anv_obj)
public function dotnetobject of_getpdfobject(dotnetobject anv_obj)
public function dotnetobject of_getpdfobjectrelease(dotnetobject anv_obj,dotnetobject anv_parent)
public function dotnetobject of_getpdfobject(dotnetobject anv_obj,dotnetobject anv_parent)
...
public subroutine  of_releaselastxrefpartial(dotnetobject anv_obj)
public function dotnetobject of_addpdfobject(dotnetobject anv_obj)
public function double of_dumpperc()
public function dotnetobject of_killindirect(dotnetobject anv_obj)
public function blob of_flatedecode(blob ablo_inp)
public function blob of_decodepredictor(blob ablo_inp,dotnetobject anv_dicpar)
...
/* Trigger the dotnet function */
lbyt_result = This.flatedecode(ablo_inp,abln_strict)
Return lbyt_result
end function

public function blob of_asciihexdecode(blob ablo_inp);
//*-----------------------------------------------------------------*/
//*  .NET function : ASCIIHexDecode
//*   Argument:
//*              Blob ablo_inp
//*   Return : Blob
//*-----------------------------------------------------------------*/
...
/* Trigger the dotnet function */
lbyt_result = This.asciihexdecode(ablo_inp)
Return lbyt_result
end function

public function blob of_ascii85decode(blob ablo_inp);
//*-----------------------------------------------------------------*/
//*  .NET function : ASCII85Decode
//*   Argument:
//*              Blob ablo_inp
//*   Return : Blob
//*-----------------------------------------------------------------*/
...
/* Trigger the dotnet function */
lbyt_result = This.ascii85decode(ablo_inp)
Return lbyt_result
end function

public function blob of_lzwdecode(blob ablo_inp);
//*-----------------------------------------------------------------*/
//*  .NET function : LZWDecode
//*   Argument:
//*              Blob ablo_inp
//*   Return : Blob
//*-----------------------------------------------------------------*/
...
/* Trigger the dotnet function */
lbyt_result = This.lzwdecode(ablo_inp)
Return lbyt_result
end function
...
/* Trigger the dotnet function */
lbyt_result = This.getpagecontent(anv_page)
Return lbyt_result
end function
...
public function blob of_decodebytes(blob ablo_b,dotnetobject anv_streamdictionary);
//*-----------------------------------------------------------------*/
//*  .NET function : DecodeBytes
//*   Argument:
//*              Blob ablo_b
//*              Dotnetobject anv_streamdictionary
//*   Return : Blob
//*-----------------------------------------------------------------*/
/* Store the Return value from dotnet function */
Blob lbyt_result
...
/* Trigger the dotnet function */
lbyt_result = This.decodebytes(ablo_b,anv_streamdictionary)
Return lbyt_result
end function
...
//*              Blob ablo_b
//*              Dotnetobject anv_streamdictionary
//*              Dotnetobject anv_filterhandlers
//*   Return : Blob
//*-----------------------------------------------------------------*/
/* Store the Return value from dotnet function */
Blob lbyt_result
...
/* Trigger the dotnet function */
lbyt_result = This.decodebytes(ablo_b,anv_streamdictionary,anv_filterhandlers)
Return lbyt_result
end function

public function blob of_getstreambytes(dotnetobject anv_stream,dotnetobject anv_file);
//*-----------------------------------------------------------------*/
//*  .NET function : GetStreamBytes
//*   Argument:
...
/* Trigger the dotnet function */
lbyt_result = This.getstreambytes(anv_stream,anv_file)
Return lbyt_result
end function
...
/* Trigger the dotnet function */
lbyt_result = This.getstreambytes(anv_stream)
Return lbyt_result
end function

public function blob of_getstreambytesraw(dotnetobject anv_stream,dotnetobject anv_file);
//*-----------------------------------------------------------------*/
//*  .NET function : GetStreamBytesRaw
//*   Argument:
//*              Dotnetobject anv_stream
//*              Dotnetobject anv_file
//*   Return : Blob
...
/* Trigger the dotnet function */
lbyt_result = This.getstreambytesraw(anv_stream,anv_file)
Return lbyt_result
end function
...
/* Trigger the dotnet function */
lbyt_result = This.getstreambytesraw(anv_stream)
Return lbyt_result
end function
...
public function dotnetobject of_getnormalizedrectangle(dotnetobject anv_box);
//*-----------------------------------------------------------------*/
//*  .NET function : GetNormalizedRectangle
//*   Argument:
//*              Dotnetobject anv_box
//*   Return : Dotnetobject
//*-----------------------------------------------------------------*/
/* Store the Return value from dotnet function */
Dotnetobject lnv_result
...
/* Trigger the dotnet function */
lnv_result = This.getnormalizedrectangle(anv_box)
Return lnv_result
end function
...
/* Trigger the dotnet function */
lnv_result = This.getpdfobjectrelease(anv_obj)
Return lnv_result
end function
...
/* Trigger the dotnet function */
lnv_result = This.getpdfobject(anv_obj)
Return lnv_result
end function
...
/* Trigger the dotnet function */
lnv_result = This.getpdfobjectrelease(anv_obj,anv_parent)
Return lnv_result
end function
...
/* Trigger the dotnet function */
lnv_result = This.getpdfobject(anv_obj,anv_parent)
Return lnv_result
end function
...
/* Trigger the dotnet function */
This.releaselastxrefpartial(anv_obj)
end subroutine
...
/* Trigger the dotnet function */
lnv_result = This.killindirect(anv_obj)
Return lnv_result
end function
...
/* Trigger the dotnet function */
lbyt_result = This.flatedecode(ablo_inp)
Return lbyt_result
end function

public function blob of_decodepredictor(blob ablo_inp,dotnetobject anv_dicpar);
//*-----------------------------------------------------------------*/
//*  .NET function : DecodePredictor
//*   Argument:
//*              Blob ablo_inp
//*              Dotnetobject anv_dicpar
//*   Return : Blob
//*-----------------------------------------------------------------*/
/* Store the Return value from dotnet function */
Blob lbyt_result
...
/* Trigger the dotnet function */
lbyt_result = This.decodepredictor(ablo_inp,anv_dicpar)
Return lbyt_result
end function
...
on nvo_pdfreader.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_pdfreader.destroy
