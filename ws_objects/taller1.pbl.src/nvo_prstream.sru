$PBExportHeader$nvo_prstream.sru
forward
global type nvo_prstream from dotnetobject
end type
end forward

global type nvo_prstream from dotnetobject
end type
global nvo_prstream nvo_prstream

type variables

PUBLIC:
String is_assemblypath = "C:\Users\CEC\Documents\APPEON_FJ\Firmar\Firmar\bin\Debug\net461\itextsharp.dll"
String is_classname = "iTextSharp.text.pdf.PRStream"
...
public subroutine  of_setdata(blob ablo_data,boolean abln_compress)
public subroutine  of_setdata(blob ablo_data,boolean abln_compress,long al_compressionlevel)
public subroutine  of_setdataraw(blob ablo_data)
public subroutine  of_setdata(blob ablo_data)
public function blob of_getbytes()
public subroutine  of_topdf(dotnetobject anv_writer,dotnetobject anv_os)
public subroutine  of_writelength()
public subroutine  of_flatecompress()
public subroutine  of_flatecompress(long al_compressionlevel)
public subroutine  of_writecontent(dotnetobject anv_os)
...
public subroutine  set_length(long al_value)
public function longlong get_offset()
public function dotnetobject get_reader()
public function long get_objnum()
public subroutine  set_objnum(long al_value)
public function long get_objgen()
public subroutine  set_objgen(long al_value)
public function long get_rawlength()
...
This.setdata(ablo_data,abln_compress)
end subroutine
...
/* Trigger the dotnet function */
This.setdata(ablo_data,abln_compress,al_compressionlevel)
end subroutine

public subroutine  of_setdataraw(blob ablo_data);
//*-----------------------------------------------------------------*/
//*  .NET function : SetDataRaw
//*   Argument:
//*              Blob ablo_data
//*   Return : (None)
//*-----------------------------------------------------------------*/
...
/* Trigger the dotnet function */
This.flatecompress(al_compressionlevel)
end subroutine

public subroutine  of_writecontent(dotnetobject anv_os);
//*-----------------------------------------------------------------*/
//*  .NET function : WriteContent
//*   Argument:
//*              Dotnetobject anv_os
//*   Return : (None)
//*-----------------------------------------------------------------*/
...
/* Trigger the dotnet property */
This.objgen = al_value
end subroutine

public function long get_rawlength();
//*-----------------------------------------------------------------*/
//*  .NET property : RawLength
//*   Return : Long
//*-----------------------------------------------------------------*/
/* Store the Return value from dotnet property */
Long ll_result
...
on nvo_prstream.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_prstream.destroy
